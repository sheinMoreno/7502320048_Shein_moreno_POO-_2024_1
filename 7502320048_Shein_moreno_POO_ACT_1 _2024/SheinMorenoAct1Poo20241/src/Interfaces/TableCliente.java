 ...
 * @author ASUS
 */
public class TableCliente extends JTable{
    
    private EncabezamiendoTableDark header;
    private TableDarkCell cell;
    
    public TableCliente() {
        header = new EncabezamiendoTableDark();
    ...
    private class EncabezamiendoTableDark extends DefaultTableCellRenderer {
